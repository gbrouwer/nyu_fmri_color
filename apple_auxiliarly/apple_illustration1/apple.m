...
command = ['rpict -x 1400 -y 1400 -pa 0.75 -vh 100 -vv 80 -ds 0 -ab 0 -aa 0.1 -ad 2048 -as 1 -ps 8 -vp -10.00 0.00 6 -vd 1 0 -0.5 -av ' num2str(lightsources(1,:)) ' ' radfile(1:end-4) '.oct > ' radfile(1:end-4) '.pic'];
system(command);
pname = 'apple.pic';
tname = 'apple.tiff';
