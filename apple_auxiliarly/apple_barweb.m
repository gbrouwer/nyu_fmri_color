function handles = saffron_barweb(barvalues, errors, width, groupnames, bw_title, bw_xlabel, bw_ylabel, bw_colormap, gridstatus, bw_legend, error_sides, legend_type)
...
%
% The following default values are used if parameters are left out or
% skipped by using [].
