...
%             you want to have the same voxels from different sessions. If
%             matchGroupNum
...
function scanCoords = apple_getROICoordinatesMatching(v,roiNum,scanNum,matchScanNum,groupNum,matchGroupNum)
