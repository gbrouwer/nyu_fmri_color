...
%             the directory
function scanCoords = apple_getROICoordinates(view,roiNum,scanNum,groupNum)
...
scanCoords = round(carolina_xformROIcoords(roiCoords,inv(scan2roi),roiVoxelSize,scanVoxelSize));
